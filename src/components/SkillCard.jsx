...
export default function SkillCard({ name, iconPlaceholder, iconBgGradient }) {
  return (
    ...
    <div className="flex border-gray-900 flex-col p-4 bg-gray-900 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105 hover:border-[#FFCC00] hover:border-2 hover:bg-gray-800 ease-in-out">
